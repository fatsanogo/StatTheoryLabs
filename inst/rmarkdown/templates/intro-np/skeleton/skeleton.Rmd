...
There are **9** people in this class, including Prof. Sanogo. Let's suppose each person in the class is assigned a different number from 1 through 9. Using `sample()`, randomly select four numbers from this list, **with replacement**. 
