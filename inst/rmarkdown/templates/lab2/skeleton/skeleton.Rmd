...
#### 7. In the chunk below, we are creating a density histogram of the 1000 sample values for the variable you created in step 4.  In a second layer, a we have a plot of the pdf for the distribution. In a third layer, a plot of the pdf of a Normal(0, 1) distribution using a different color. Play with this code by plotting the other distributions you have above.
