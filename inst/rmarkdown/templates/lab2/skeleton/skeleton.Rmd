...
#### 1. Below I created a data frame with 5 variables in it called `x1`, `x2`, `x3`, `x4`, and `x5` and draw a sample of size $n = 1000$ for each of these variables, from a Normal(0, 1) distribution. Perform the code annotation steps on the code chunk below (see lab 1 template for code annotation steps)
...
#### 2. Create a new variable in your data frame called `u`, calculated as `x1^2 + x2^2 + x3^2`. Hint: see step 3 above (Example code to start with section). What is the distribution of the random variable U we have sampled from?
